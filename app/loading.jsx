    ...
    return(
        ...
        <header>
         ...
         <main
          ...
          className=' flex self-center place-content-center bg-cover  bg-gray-800 text-center p-5 max-w-full min-w-screen  min-h-screen max-h-full overflow-hidden'>
     
   

     <div className=' md:w-[70rem] lg:w-[80rem] w-[40rem] mr-0 flex-col '>
        <div className="mt-[25%]">
                    <p className='text-3xl mt-20   font-bold text-pink-400 '>Loading</p>
