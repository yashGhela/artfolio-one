...
export default  function PrivacyPolicy(){
  return(
      ...
      <header>
       ...
       <main className=' flex self-center place-content-center  text-gray-100 bg-gray-800 text-center p-5 max-w-full min-w-screen  min-h-screen max-h-full overflow-hidden'>
   
 

   <div className=' md:w-[70rem] lg:w-[80rem] w-[40rem] mr-0 flex-col'>
   <h2 className="text-center"><b>PRIVACY POLICY</b></h2>
<p>Effective date: 2023-08-28</p>
<p>1. <b>Introduction</b></p>
<p>Welcome to <b> Artfolio by Yash</b>.</p>
<p><b>Artfolio by Yash</b> (“us”, “we”, or “our”) operates <b>artfolio.space</b> (hereinafter referred to as <b>“Service”</b>).</p>
<p>Our Privacy Policy governs your visit to <b>artfolio.space</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
...
<p><b>SERVICE</b> means the artfolio.space website operated by Artfolio by Yash.</p>
...
<p>Artfolio by Yash uses the collected data for various purposes:</p>
...
<p>Artfolio by Yash will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
...
<p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>nitrondigital@gmail.com</b>.</p>
...
<p>0.4. users are able to change their personal information by emailing us at <b>nitrondigital@gmail.com</b>.</p>
...
<p>To exercise your California data protection rights described above, please send your request(s) by email: <b>nitrondigital@gmail.com</b>.</p>
...
<p>If you have any questions about this Privacy Policy, please contact us by email: <b>info@artfolio.space</b>.</p>
      </div>
